    ...
    (() => {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            if (oneSpoller && !spollerTitle.classList.contains("_spoller-active")) {
                                ...
                                document.querySelector("html").classList.remove("_submenu-active");
                            }
                            if (spollerTitle.classList.contains("main-menu-btn")) document.querySelector("html").classList.toggle("_submenu-active");
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (document.querySelector("html").classList.contains("lock") && !e.target.closest(".menu__body") && !e.target.closest(".popup")) functions_menuClose();
                if (bodyLockStatus && (e.target.closest(".icon-menu") || e.target.classList.contains("head-menu__close"))) {
                    bodyLockToggle();
        ...
        function initSliders() {
            if (document.querySelector(".hero-slider__slider")) new core(".hero-slider__slider", {
                ...
                pagination: {
                    el: ".hero-slider__swiper-pagination",
                    clickable: true
                },
                navigation: {
            ...
            if (document.querySelector(".recommended__slider")) new core(".recommended__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".arrivals__slider")) new core(".arrivals__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrivals__button-prev",
                    nextEl: ".arrivals__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.3,
            ...
            if (document.querySelector(".best__slider")) new core(".best__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
